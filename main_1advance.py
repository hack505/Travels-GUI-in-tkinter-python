...
def accpted_value():
    ...
    if a1 == "1":
        print("accpted to the terms and agreement")
    else:
        print("Not accpted to the terms and agreement")'''
...
def getvalue():
    print("----------------BOOKED----------------")
    print(customnovalue.get() ,custompasswordvalue.get() ,namevalue.get() ,gendervalue.get() ,agevalue.get() ,from1value.get() ,"to", tovalue.get() ,paymentmodevalue.get() ,phonevalue.get() ,emailvalue.get() , accptedvalue.get())
    print("----------------BOOKED----------------")
    ...
    tmsg.showinfo("505 TRAVLS", "BOOKED")
